                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$value->name}}</td>
                      <td>
                        <a href="{{route('todo.home.task.edit',$value->id)}}" title="Edit" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
                        <a href="{{route('todo.home.task.edit',$value->id)}}" title="Edit" class="btn btn-sm btn-success"><i class="fa fa-check"></i></a>
